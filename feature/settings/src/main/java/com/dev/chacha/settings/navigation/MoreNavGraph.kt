package com.dev.chacha.settings.navigation

import androidx.navigation.NavGraphBuilder
import androidx.navigation.NavHostController
import androidx.navigation.compose.composable
import com.dev.chacha.settings.presentation.settings_more.MoreScreen
import com.dev.chacha.settings.presentation.change_language.ChangeLanguageScreen
import com.dev.chacha.settings.presentation.get_touch.GetInTouchScreen
import com.dev.chacha.settings.presentation.manage_devices_screen.ManageDeviceScreen
import com.dev.chacha.settings.presentation.manage_devices_screen.MobileDevicesScreen
import com.dev.chacha.settings.presentation.notification_preferences.BankAccountNotifications
import com.dev.chacha.settings.presentation.security.SecurityScreen
import com.dev.chacha.settings.presentation.notification_preferences.NotificationPreferences
import com.dev.chacha.settings.presentation.notification_preferences.ReminderNotificationScreen
import com.dev.chacha.settings.presentation.notification_preferences.TransactionAlertScreen
import com.dev.chacha.settings.presentation.notification_screen.NotificationScreen
import com.dev.chacha.settings.presentation.reset_password_screen.ResetPasswordScreen
import com.dev.chacha.settings.presentation.reset_pin_screen.ResetPinScreen
import com.dev.chacha.settings.presentation.support_scrren.SupportScreen
